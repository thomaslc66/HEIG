...
#ifndef LINKER_LISTS_H
#define LINKER_LISTS_H
...
#define ll_entry_declare(_type, _name, _list)				\
	_type _u_boot_list_2_##_list##_2_##_name __aligned(4)		\
			...
			section(".linker_list_2_"#_list"_2_"#_name)))
...
({									\
	static char start[0] __aligned(4) __attribute__((unused,	\
		section(".linker_list_2_"#_list"_1")));			\
	(_type *)&start;						\
})
...
({									\
	static char end[0] __aligned(4) __attribute__((unused,	\
		section(".linker_list_2_"#_list"_3")));			\
	(_type *)&end;							\
})
/**
...
#define ll_entry_get(_type, _name, _list)				\
	({								\
		extern _type linker_list_2_##_list##_2_##_name;	\
		_type *_ll_result =					\
			&linker_list_2_##_list##_2_##_name;	\
		_ll_result;						\
	})
...
({									\
	static char end[0] __aligned(4) __attribute__((unused,	\
		section(".linker_list_3")));				\
	(_type *)&end;							\
})

#endif /* __ASSEMBLY__ */

#endif	/* LINKER_LISTS_H */
